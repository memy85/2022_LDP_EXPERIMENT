...
python3 src/2_evaluation/classify.py --name creatinine --type lm --epsilon 0.1
python3 src/2_evaluation/classify.py --name creatinine --type lm --epsilon 0.2
python3 src/2_evaluation/classify.py --name creatinine --type lm --epsilon 0.4
python3 src/2_evaluation/classify.py --name creatinine --type lm --epsilon 0.8
python3 src/2_evaluation/classify.py --name creatinine --type lm --epsilon 1.6
python3 src/2_evaluation/classify.py --name creatinine --type lm --epsilon 3.2
python3 src/2_evaluation/classify.py --name creatinine --type lm --epsilon 6.4

python3 src/2_evaluation/classify.py --name creatinine --type new_lm --epsilon 0.1
python3 src/2_evaluation/classify.py --name creatinine --type new_lm --epsilon 0.2
python3 src/2_evaluation/classify.py --name creatinine --type new_lm --epsilon 0.4
python3 src/2_evaluation/classify.py --name creatinine --type new_lm --epsilon 0.8
python3 src/2_evaluation/classify.py --name creatinine --type new_lm --epsilon 1.6
python3 src/2_evaluation/classify.py --name creatinine --type new_lm --epsilon 3.2
python3 src/2_evaluation/classify.py --name creatinine --type new_lm --epsilon 6.4

echo "ended creatinine"
